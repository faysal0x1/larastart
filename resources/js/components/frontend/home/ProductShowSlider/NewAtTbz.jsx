...
export default function NewAtTbz({ onAddToCart }) {
    ...
    useEffect(() => {
        ...
        async function load() {
            try {
                setLoading(true)
                setError(null)
                const res = await fetch('/web/new-at-tbz-products?limit=24', {
    ...
    return (
        <div className="max-w-[1680px] mx-auto px-4 py-8">
            <div className="flex items-center justify-between mb-8">
                <h1 className="text-3xl font-bold text-gray-900">New At Tbz</h1>
