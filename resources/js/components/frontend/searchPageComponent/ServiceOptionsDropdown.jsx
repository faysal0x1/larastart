...
const ServiceOptionsDropdown = ({ isOpen, toggle, selected, setSelected }) => {
    const serviceOptions = {
      'Website type': ['Business', 'E-Commerce store', 'Landing page', 'SaaS'],
      'Service offerings': ['Offers subscriptions', 'Paid video consultations'],
      'Website features': ['Payment', 'Social media', 'Marketing', 'Form'],
      'Plugins': ['Elementor', 'WooCommerce', 'Contact form 7', 'All-in-one SEO pack']
    };
