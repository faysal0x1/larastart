...
import 'swiper/css';
import 'swiper/css/navigation'; // Color mapping for consistent color display
...
const BestSellers = () => {
    ...
    const products = [
        {
            ...
            images: {
                red: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'],
                blue: ['https://images.unsplash.com/photo-1527719327859-c6ce80353573?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'],
                green: ['https://images.unsplash.com/photo-1529374255404-311a2a4f1fd9?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'],
            },
            totalQuantity: 450,
            inventory: {
                red: {
        ...
        },
        {
            ...
            images: {
                pink: ['https://images.unsplash.com/photo-1539109136881-3be0616acf4b?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'],
                white: ['https://images.unsplash.com/photo-1551232864-3f0890e580d9?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'],
                gold: ['https://images.unsplash.com/photo-1551232864-3f0890e580d9?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80&view=gold'],
            },
            totalQuantity: 350,
            inventory: {
                pink: {
        ...
        },
        {
            ...
            images: {
                brown: ['https://images.unsplash.com/photo-1598033129183-c4f50c736f10?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'],
                blue: ['https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'],
                beige: ['https://images.unsplash.com/photo-1620799139834-6b8f844dbbe6?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'],
            },
            totalQuantity: 425,
            inventory: {
                brown: {
        ...
        },
        {
            ...
            images: {
                black: ['https://images.unsplash.com/photo-1556905055-8f358a7a47b2?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'],
                gray: ['https://images.unsplash.com/photo-1542272604-787c3835535d?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'],
                slate: ['https://images.unsplash.com/photo-1556905055-8f358a7a47b2?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80&view=slate'],
            },
            totalQuantity: 375,
            inventory: {
                black: {
        ...
        },
        {
            ...
            images: {
                blue: ['https://images.unsplash.com/photo-1591047139829-d91aecb6caea?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80'],
                black: ['https://images.unsplash.com/photo-1591047139829-d91aecb6caea?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80&view=black'],
                brown: ['https://images.unsplash.com/photo-1591047139829-d91aecb6caea?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80&view=brown'],
            },
            totalQuantity: 490,
            inventory: {
                blue: {
    ...
    const filteredProducts = products.filter((product) => {
        ...
        if (activeFilter === 'On Sale') return product.isOnSale;
        if (activeFilter === 'New Arrivals') return product.isNew;
        return true;
    });

    const openQuickView = (product) => {
        setQuickViewModal({ open: true, product });
    };
    ...
    const closeQuickView = () => {
        setQuickViewModal({ open: false, product: null });
    };
    ...
    return (
        <section className="container mx-auto px-4 py-12">
            <div className="mb-8 flex items-center justify-between">
                <h2 className="text-3xl font-bold">{activeFilter}</h2>
                <div className="flex gap-4">
                    {['Best Sellers', 'On Sale', 'New Arrivals'].map((filter) => (
                        <button
                            key={filter}
                            className={`rounded-full px-4 py-2 text-sm font-medium transition-colors ${
                                activeFilter === filter ? 'bg-black text-white' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'
                            }`}
            ...
            >
                {filteredProducts.map((product) => {
                    ...
                    const mainImage = product.images[selectedColor]?.[0] || product.defaultImages[0];
                        ...
                        <SwiperSlide key={product.id}>
                            ...
                            >
                                ...
                                <div className="relative mt-4 h-20">
                                    <h3
                                        className={`font-medium text-gray-900 transition-opacity ${
                                    ...
                                    <div
                                        className={`absolute top-0 left-0 flex gap-2 transition-opacity ${
                                    ...
                                    <div className="absolute bottom-0 left-0 mt-2">
                                        {isOnSale ? (
                                            <>
                                                <span className="font-bold text-[#e53e29]">${product.price.toFixed(2)}</span>
            ...
            {quickViewModal.open && (
                <ModalQuickview isOpenQuickView={quickViewModal.open} product={quickViewModal.product} onCloseQuickView={closeQuickView} />
            )}

            {cartModal.open && <CartModal isOpenCart={cartModal.open} product={cartModal.product} onCloseCart={closeCartModal} />}
        </section>
    );
};
