...
import { Eye, EyeOff, Lock, Mail, ShoppingBag, User, ArrowRight } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p className="mt-2 text-center text-sm text-gray-600">
                    Join thousands of shoppers on our platform
                </p>
            </div>
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                ...
                                <input
                                    ...
                                    autoComplete="name"
                                    required
                                    className={`block w-full pl-10 pr-3 py-2 border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                ...
                                <input
                                    ...
                                    autoComplete="new-password"
                                    required
                                    className={`block w-full pl-10 pr-10 py-2 border ${errors.password_confirmation ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm`}
