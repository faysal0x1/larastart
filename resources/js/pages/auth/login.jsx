                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            {canResetPassword && (
                                <div className="text-sm">
                                    <a href={route('password.request')} className="font-medium text-indigo-600 hover:text-indigo-500">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <TextLink href={route('register')} className="font-medium text-indigo-600 hover:text-indigo-500">
                                Create one now
                            </TextLink>
                        </p>
                    </div>
