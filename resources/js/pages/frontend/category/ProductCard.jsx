...
export default function ProductCard({ product }) {
    return (
        <div className="group rounded-md border border-gray-200 bg-transparent p-0 shadow-none hover:shadow-none transition-none">
            <div className="relative aspect-[4/3] w-full overflow-hidden bg-transparent flex items-center justify-center">
                ...
                <button className="absolute right-2 top-2 inline-flex h-8 w-8 items-center justify-center rounded-full bg-white shadow border border-gray-200">
            ...
            <div className="mt-3 px-3 pb-3">
                ...
                <h3 className="mt-1 line-clamp-2 text-sm font-medium text-gray-900">{product.title}</h3>
                <div className="mt-2">
                ...
                <div className="mt-3">
                    <button className="w-full rounded bg-orange-500 px-3 py-2 text-white text-sm font-semibold hover:bg-orange-600">
                        ADD TO CART
