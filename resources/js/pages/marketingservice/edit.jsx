                                ...
                                <div className="border-b border-gray-200">
                                    <nav className="-mb-px flex space-x-8" aria-label="Tabs">
                                        <button
                                            ...
                                            className={`border-b-2 px-1 py-4 text-sm font-medium ${activeTab === 'credentials'
                                        ...
                                        <button
                                            ...
                                            className={`border-b-2 px-1 py-4 text-sm font-medium ${activeTab === 'tracking_scripts'
                                                    ? 'border-blue-500 text-blue-600'
                                                    : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'
                                                } `}
                                        >
                                        ...
                                        <button
                                            ...
                                            className={`border-b-2 px-1 py-4 text-sm font-medium ${activeTab === 'help'
                                                    ? 'border-blue-500 text-blue-600'
                                                    : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'
                                                } `}
                                        >
