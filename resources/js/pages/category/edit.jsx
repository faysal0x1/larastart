...
export default function edit() {
    const { category, parentCategories, permissions, auth } = usePage().props;
    ...
    const filteredParentCategories = parentCategories.filter((cat) => cat.name.toLowerCase().includes(parentSearch.toLowerCase()));
                ...
                <div className="mx-auto max-w-4xl sm:px-6 lg:px-8">
                    <div className="mb-8">
                        <ImageUpdateComponent
                            ...
                            fieldName="image"
                            initialImage={category.image_url ? category.image : null}
                            submitUrl={route('admin.generic.image.update', { model: 'category', id: category.id })}
                        />
                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <p className="text-muted-foreground text-sm">
                                Update category information and hierarchy. Current level: {category.level || 0}
                            </p>
                        </CardHeader>
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                {/*            Current level: {category.level || 0} |*/}
                                {/*            Current path: {category.path || 'Root'}*/}
                                {/*        </p>*/}
                                {/*    </div>*/}
                                {/*</div>*/}
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            />
                                            {data.meta_image && <p className="text-sm text-green-600">Selected: {data.meta_image.name}</p>}
                                            {category.meta_image && !data.meta_image && (
                                                <p className="text-sm text-blue-600">Current: {category.meta_image}</p>
                                            )}
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                        ...
                                        {/*    />*/}
                                        {/*    {data.image && <p className="text-sm text-green-600">Selected: {data.image.name}</p>}*/}
                                        {/*    {category.image && !data.image && <p className="text-sm text-blue-600">Current: {category.image}</p>}*/}
                                        ...
                                        {/*    />*/}
                                        {/*    {data.banner && <p className="text-sm text-green-600">Selected: {data.banner.name}</p>}*/}
                                        {/*    {category.banner && !data.banner && <p className="text-sm text-blue-600">Current: {category.banner}</p>}*/}
