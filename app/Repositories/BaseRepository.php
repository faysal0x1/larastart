...
abstract class BaseRepository implements RepositoryInterface
{
    ...
    public function withRelations(array $relations, array $columns = ['*']): Collection
    {
        return $this->model->with($relations)->get($columns);
    }

    // With Relation for Single Record
    public function withRelation(array $relation, int $id): ?Model
    {
