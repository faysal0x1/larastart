...
//                    ->usingFileName(function (FileAdder $fileAdder) use ($options) {
//                        $originalName = pathinfo($fileAdder->getFile()->getClientOriginalName(), PATHINFO_FILENAME);
//                        return $originalName . '.' . $options['format'];
//                    })
//                    ->usingName(function (FileAdder $fileAdder) use ($options) {
//                        $originalName = pathinfo($fileAdder->getFile()->getClientOriginalName(), PATHINFO_FILENAME);
//                        return $originalName . '.' . $options['format'];
//                    })
