...
use App\Services\MarketingServices;
use Closure;
...
class InjectTrackingScripts
{
	...
	/**
	 * Load all scripts for all locations in a single database query
	 */
	protected function loadAllScripts(): void
	{
		// Only load scripts once
		if ($this->scripts === null) {
			$this->scripts = $this->marketingService->getScriptsForLocations([
